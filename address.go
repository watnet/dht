...
func NewAddress(version int) (Address, error) {
	// TODO: Addresses should be public keys generated by the crypto/ed25519 package, not
	// completely random sets of bytes. There also needs to be a way to get the private key.
	// Generating a new, random address and not having the corresponding private key is kind of
	// pointless.
